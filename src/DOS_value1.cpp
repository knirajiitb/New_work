...
double DOS_value1(double energy, int a)
{
    ...
    cout<<"temp = "<<temp<<endl;
    cout<<"index_earlier = "<<index_earlier<<endl;
    cout<<"index_after = "<<index_after<<endl;
    cout<<"ds = "<<ds<<endl;
    cout<<"slope = "<<slope<<endl;
    cout<<"energy_earlier = "<<energy_earlier<<endl;
    cout<<"DOS[index_after][1] = "<<DOS[index_after][1]<<endl;
    cout<<"DOS[index_earlier][1] = "<<DOS[index_earlier][1]<<endl;
    cout<<"DOS[index_after][0]"<<DOS[index_after][0]<<endl;
    cout<<"DOS[index_earlier][0] = "<<DOS[index_earlier][0]<<endl;
